...
const toolContentFallback: ToolContent = {
  title: 'Alat PDF',
  metaDescription: 'Proses dokumen PDF secara lokal di browser.',
  keywords: ['alat PDF', 'dokumen PDF'],
  description: '<p>Proses dokumen PDF secara lokal di browser tanpa mengunggah file ke server.</p>',
  howToUse: [{ step: 1, title: 'Unggah file', description: 'Pilih file PDF yang ingin diproses.' }],
  useCases: [{ title: 'Pemrosesan dokumen', description: 'Gunakan alat ini untuk kebutuhan dokumen PDF internal.', icon: 'file-text' }],
  faq: [{ question: 'Apakah file dikirim ke server?', answer: 'Tidak, pemrosesan berlangsung lokal di browser.' }],
};

const toolContentEn = new Proxy<Record<string, ToolContent>>({}, {
  get: () => toolContentFallback,
});
